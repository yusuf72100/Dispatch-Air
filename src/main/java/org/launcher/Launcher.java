...
public class Launcher {
   ...
   */
  public static String dossierdispatchAir = "DispatchAir";
  ...
  public static void main(String[] args) throws IOException {
    ...
    int lastIdx = Paths.get(cheminDossierDestinationRessourceDispatchAir).toAbsolutePath().toString().lastIndexOf(File.separator);
    String cheminDossierParentRessourcesLocal = Paths.get(cheminDossierDestinationRessourceDispatchAir).toAbsolutePath().toString().substring(0, lastIdx + 1);
    ...
    try {
      ...
      if (!isRessourcesCompletes(fichierJar, cheminDossierRessourcesJAR, cheminDossierDestinationRessourceDispatchAir)) {
        extraireRessourcesDepuisJar(fichierJar, cheminDossierRessourcesJAR, cheminDossierDestinationRessourceDispatchAir);
      }
